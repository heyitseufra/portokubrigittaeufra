...
const projectsData = [
  ...
  },
  {
    ...
    details: `
      ...
      Python's robust data processing capabilities, combined with Google Colab's computational power, ensured that my analysis was both accurate and efficient, 
